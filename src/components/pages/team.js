...
const team = () => {
  return (
    ...
    <colorpurple>geosjobbydooo</colorpurple><br/>
    <colorpurple>sardonicWarrior</colorpurple><br/>
    <colorpurple>montysCorner</colorpurple><br/>
    <colorpurple>theSkipperMan</colorpurple><br/>
    < /p>
    </div>
  );
}
